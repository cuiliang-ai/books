---
title: "第 1 章：产品特性与设计目标"
description: "自进化 Agent 与传统 AI 工具的本质区别"
sidebar:
  order: 1
---

import LearningLoopIntro from '../../../components/diagrams/LearningLoopIntro.tsx';

<LearningLoopIntro client:only="react" />
