---
title: "第 6 章：System Prompt 装配与 Prompt Caching"
description: "七层 System Prompt 如何组装"
sidebar:
  order: 6
---

import SystemPromptFlow from '../../../components/flows/SystemPromptFlow.tsx';
...
<SystemPromptFlow client:only="react" />
