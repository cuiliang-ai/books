---
title: "第 7 章：上下文压缩与 Context Engine"
description: "ContextEngine 的可插拔设计"
sidebar:
  order: 7
---

import ContextCompressorDemo from '../../../components/diagrams/ContextCompressorDemo.tsx';

> **核心问题**：ContextEngine 的可插拔设计如何工作？默认压缩器的五步算法是什么？当上下文窗口即将溢出时，Hermes 如何在保留关键信息和释放空间之间取得平衡？

<ContextCompressorDemo client:only="react" />
