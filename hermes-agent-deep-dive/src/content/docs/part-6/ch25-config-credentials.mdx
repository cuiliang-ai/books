---
title: "第 25 章：配置、凭据与 Profiles"
description: "分层配置与多密钥轮换"
sidebar:
  order: 25
---

import ConfigLayerStack from '../../../components/diagrams/ConfigLayerStack.tsx';

> **核心问题**：分层配置如何工作？多密钥轮换的 Credential Pool 如何设计？

<ConfigLayerStack client:only="react" />
