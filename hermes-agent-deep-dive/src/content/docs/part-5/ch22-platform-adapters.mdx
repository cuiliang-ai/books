---
title: "第 22 章：Platform Adapter 模式"
description: "适配器的抽象与差异化实现"
sidebar:
  order: 22
---

import PlatformAdapterCards from '../../../components/comparisons/PlatformAdapterCards.tsx';

> **核心问题**：BasePlatformAdapter 如何用三个抽象方法统一 15+ 个消息平台？各平台适配器的差异化实现有哪些值得关注的工程决策？

<PlatformAdapterCards client:only="react" />
