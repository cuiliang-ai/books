---
title: "第 10 章：Tool Registry 与发现链"
description: "工具如何自注册、发现、调度"
sidebar:
  order: 10
---

import ToolRegistryGraph from '../../../components/diagrams/ToolRegistryGraph.tsx';

<ToolRegistryGraph client:only="react" />
