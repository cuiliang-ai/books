---
title: "第 14 章：Browser 自动化与 MCP 协议"
description: "无视觉浏览器操控与开放工具扩展"
sidebar:
  order: 14
---

import BrowserMCPFlow from '../../../components/flows/BrowserMCPFlow.tsx';

<BrowserMCPFlow client:only="react" />
