---
title: "第 12 章：六种 Terminal 后端"
description: "统一抽象如何适配 6 种执行环境"
sidebar:
  order: 12
---

import TerminalBackendsCompare from '../../../components/comparisons/TerminalBackendsCompare.tsx';

<TerminalBackendsCompare client:only="react" />
