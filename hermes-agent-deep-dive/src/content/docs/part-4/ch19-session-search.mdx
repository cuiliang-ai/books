---
title: "第 19 章：Session Search 与跨会话召回"
description: "FTS5 + LLM 摘要的跨会话回忆"
sidebar:
  order: 19
---

import SessionSearchDemo from '../../../components/simulators/SessionSearchDemo.tsx';

> **核心问题**：FTS5 全文检索 + LLM 摘要如何实现跨会话的长期记忆？

<SessionSearchDemo client:only="react" />
