---
title: "第 20 章：封闭学习循环 — 自我进化的闭环"
description: "自我进化闭环的完整数据流"
sidebar:
  order: 20
---

import LearningLoopDiagram from '../../../components/diagrams/LearningLoopDiagram.tsx';
...
<LearningLoopDiagram client:only="react" />
