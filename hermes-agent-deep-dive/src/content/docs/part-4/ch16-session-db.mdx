---
title: "第 16 章：会话存储 SessionDB"
description: "SQLite + FTS5 的持久化设计"
sidebar:
  order: 16
---

import SessionDBSchema from '../../../components/diagrams/SessionDBSchema.tsx';

> **核心问题**：Agent 的对话记录存在哪里？谁在读写它？它如何支撑记忆、搜索、费用追踪等上层功能？

<SessionDBSchema client:only="react" />
