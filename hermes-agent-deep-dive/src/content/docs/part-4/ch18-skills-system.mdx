---
title: "第 18 章：Skills 系统 — 程序化记忆"
description: "渐进式披露与 Skills Hub"
sidebar:
  order: 18
---

import SkillDiscoveryFlow from '../../../components/flows/SkillDiscoveryFlow.tsx';
...
<SkillDiscoveryFlow client:only="react" />
